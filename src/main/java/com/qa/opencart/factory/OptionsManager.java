 ...
 * This class is responsible for chrome and firefox options
 * and depand on config.properties file.
 */ 
public class OptionsManager
{
	...
	public FirefoxOptions getFirefoxOptions()
	{
		...
		if(Boolean.parseBoolean(prop.getProperty("incognito").trim())) fo.addArguments("--incogmito");
		return fo;
